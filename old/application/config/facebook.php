...
$config['facebook_app_id']              = '448166322227963';
$config['facebook_app_secret']          = '714c2d12571b5cc771034308f73e5203';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'index.php/CustomerController/login';
$config['facebook_logout_redirect_url'] = 'index.php/CustomerController/fb_logout';
