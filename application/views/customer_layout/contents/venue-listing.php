  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 tp-title">
        <h2>(12) Venue Vendor </h2>
      </div>
      <div class="col-md-4 text-right">
        <div class="btn-group"> <a href="vendor-list.html" id="list" class="btn list-btn btn-sm"><span class="fa fa-th-list"> </span> </a> <a href="#" id="grid" class="btn  grid-btn active  btn-sm"><span class="fa fa-th"></span> </a> </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well-box feature-left">
              <div class="row">
                <div class="col-md-2 feature-icon"><img src="images/venue-icon.svg" alt=""></div>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-3.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Venue Vendor Title</a></h2>
          ...
          <!-- /.venue box start-->
          <div class="col-md-12 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-4.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
