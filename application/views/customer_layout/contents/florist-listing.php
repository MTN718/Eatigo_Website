  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">Flower Vendor </li>
        </ol>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 tp-title">
        <h2>(12) Flower Vendor </h2>
      </div>
      <div class="col-md-4 text-right">
        <div class="btn-group">
            <a href="#" id="list" class="btn list-btn btn-sm"><span class="fa fa-th-list">
            </span> </a> <a href="#" id="grid" class="btn  grid-btn active  btn-sm"><span
                class="fa fa-th"></span> </a>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="filter-sidebar">
          ...
          <form>
            <div class="col-md-12 form-group">
              <label class="control-label" for="flowerservice">Flower Service</label>
              <select id="flowerservice" name="flowerservice" class="form-control">
                <option value="">Flower Service</option>
            ...
            <div class="col-md-12 form-group">
              ...
              <select id="price" name="price" class="form-control">
                ...
                <option value="$1000 - $1999">$100 - $199</option>
                <option value="$2000 - $2999">$200 - $299</option>
                <option value="$3000 - $3999">$300 - $399</option>
                <option value="$4000 - $4999">$400 - $499</option>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well-box feature-left">
              <div class="row">
              <div class="col-md-2 feature-icon"><img src="images/florist-icon.svg" alt=""></div>
              <div class="col-md-10 feature-info"><h1>Wedding Florists</h1>

              <p> Flowers often play a major role in conveying the style of a wedding and help make it memorable and beautiful.</p></div>
</div>
            </div>
            </div>
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              ...
              <div class="popular-label"></div><div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div>
            </div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
                ...
                <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
                  <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="rating-count">(22)</span> </div>
              </div>
              <!-- /.caption -->
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              ...
              <div class="rated-label"></div><div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div>
            </div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              ...
              <div class="feature-label"></div><div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div>
            </div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-4.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-5.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-6.jpg" alt="wedding venue" class="img-responsive"></a><div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div> </div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-7.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-8.jpg" alt="wedding venue" class="img-responsive"></a><div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div> </div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-9.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Florist Title</a></h2>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/florist-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:13 GMT -->
</html>