    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>Restaurant Venue Listing</h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right" style="padding-right: 0px;">
        <div class="btn-group">
            ...
            </span> </a> <a href="restaurant.html" id="grid" style="color:#706a68;" class="btn  grid-btn btn-sm"><span class="fa fa-th"></span> </a>
        </div>
      </div>
    </div>
    <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 no-right-pd">
                <div class="vendor-image"><!-- venue pic --> 
                  <a href="#"><img src="images/pica.jpg" alt="wedding venue" class="img-responsive"></a> 
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/vendor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:15 GMT -->
</html>