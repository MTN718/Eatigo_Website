  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">Wedding Cake Listings</li>
        </ol>
      </div>
        ...
        <div class="filter-sidebar">
          ...
          <form>
            <div class="col-md-12 form-group">
              ...
              <select id="desserts" name="desserts" class="form-control">
                ...
                <option value="Groom’s Cake">Groom’s Cake</option>
                <option value="Pastries">Pastries</option>
              </select>
            </div>
            <div class="col-md-12 form-group">
              <label class="control-label">Dietary</label>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well-box feature-left">
              <div class="row">
              <div class="col-md-2 feature-icon"><img src="images/cake-icon.svg" alt=""></div>
              <div class="col-md-10 feature-info"><h1>Wedding Cake</h1>

              <p> Cake often play a major role in conveying the style of a wedding and help make it memorable and beautiful.</p></div>
              </div>
            </div>
            </div>
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            ...
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Cake Vendor  Title</a></h2>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/cake-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:15 GMT -->
</html>