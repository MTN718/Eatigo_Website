    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>Venues Listing Bubba Style</h1>
        </div>
      </div>
    </div>
  </div>
...
<div class="tp-breadcrumb">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 text-right"> <a class="btn tp-btn-link" role="button" data-toggle="collapse" href="#searchform" aria-expanded="false" aria-controls="searchform">Filter</a> </div>
    </div>
  </div>
</div>
