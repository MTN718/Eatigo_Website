    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>Venues Listing Oscar Style</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">Venue Listing Oscar Style</li>
        </ol>
      </div>
      <div class="col-md-4 text-right">
      <a class="btn tp-btn-link" role="button" data-toggle="collapse" href="#searchform" aria-expanded="false" aria-controls="searchform">Filter</a> </div>
    </div>
  </div>
</div>
<!-- breadcrumb -->
<div class="filter-box collapse in" id="searchform"><!-- filter form -->
  <div class="container">
    <div class="row filter-form">
      ...
      <form>
        ...
        <div class="col-md-3">
          <button type="submit" class="btn tp-btn-default tp-btn-lg btn-block">Refine Your Search</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-9.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-4.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-5.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-6.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country.<a href="#">View more</a></p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-7.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-oscar"> <img src="images/vendor-8.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2><a href="#">Wedding Venue Name Title Here</a></h2>
              <p> Street Address, Name of Town, 12345, Country. </p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/vendor-listing-ocean.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:16 GMT -->
</html>