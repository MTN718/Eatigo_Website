    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>Wedding Venue Detail Tabbed Style</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container tabbed-page st-tabs">
    <div class="row tab-page-header">
      ...
      <div class="col-md-4 venue-data">
        ...
        <a href="#inquiry" class="btn tp-btn-default tp-btn-lg btn-block">Book Venue</a> </div>
    </div>
    <div class="row">
      <div class="col-md-12"> 
        <!-- Nav tabs -->
      ...
      <div class="col-md-4">
        <div class="profile-sidebar side-box"> 
          ...
          <div class="profile-usertitle">
            ...
            <div class="profile-email"> <i class="fa fa-envelope"></i> Info@weddingvenue.com </div>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/vendor-details-tabbed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:25 GMT -->
</html>