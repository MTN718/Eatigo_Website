    ...
    <li class="dropdown hoo"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Account <span class="fa fa-angle-down"></span></a>
        ...
        <!-- /.container-fluid --> 
          ...
          <div id="slider" class="owl-carousel owl-theme slider">
            ...
            <div class="item">
              <div class="slider-pic"><img src="images/venue-pic.jpg" alt="The Last of us"></div>  </div>
            </div>

            <div class="container venue-header">
              <div class="row venue-head">
                <div class="col-md-12 title"> 
                  <h1>Restaurant Title Goes Here</h1>
                ...
                <div class="row">
                   ...
                   <div class="container-fluid">
                    <div class="row st-tabs woo-product-tabs"> 
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#recentproducts" aria-controls="recentproducts" role="tab" data-toggle="tab">Details</a></li>
                        <li role="presentation"><a href="#featuredproduct" aria-controls="featuredproduct" role="tab" data-toggle="tab">Recommended Menu</a></li>
                        <li role="presentation"><a href="#toprated" aria-controls="toprated" role="tab" data-toggle="tab">Reviews </a></li>
                      </ul>
                  ...
                  <div class="row" style="padding-top: 16px;">
                    <div class="col-md-12">
                      ...
                      <div class="review">
                        <a class="btn tp-btn-primary btn-block tp-btn-lg findhover" role="button" data-toggle="collapse" href="#review" aria-expanded="false" aria-controls="review"  style="background-color: #8E203E"> Write A Review </a> </div>
                    ...
                    <div class="col-md-12" >
                      <div class="well-box" id="inquiry">
                        ...
                        <form class="" action="shop-checkout.html">
                            ...
                            <div class="container">
                              <div class="row">
                                ...
                                <div class="col-md-3 ft-link">
                                  <h2>Useful links</h2>
                                  <ul>
                                    <li><a href="#" style="color:#B9657C;">About Us</a></li>
                          ...
                          <!-- Mirrored from jituchauhan.com/wedding/wedding/vendor-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:21 GMT -->
                          </html>