  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active"> Videography Listings</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 tp-title">
        <h2>(12) Videography Vendor </h2>
      </div>
      <div class="col-md-4 text-right">
        <div class="btn-group"> <a href="#" id="list" class="btn list-btn btn-sm"><span class="fa fa-th-list"> </span> </a> <a href="#" id="grid" class="btn  grid-btn active btn-sm"><span
                class="fa fa-th"></span> </a> </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3">
        <div class="filter-sidebar">
          ...
          <form>
            <div class="col-md-12 form-group">
              <label class="control-label" for="videography">Videography Style</label>
              <select id="videography" name="videography" class="form-control">
            ...
            <div class="well-box feature-left">
              <div class="row">
                <div class="col-md-2 feature-icon">
                  <div class=""><img src="images/video-icon.svg" alt=""></div>
                </div>
                <div class="col-md-10 feature-info">
                  <h1>Wedding Videography</h1>
                  <p> Videography often play a major role in conveying the style of a wedding and help make it memorable and beautiful.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            ...
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Vendor Videography Title</a></h2>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/videography-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:14 GMT -->
</html>