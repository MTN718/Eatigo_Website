  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active"> Music / Dj Listings</li>
        </ol>
      </div>
          ...
          <form>
            <div class="col-md-12 form-group">
              ...
              <select id="genres" name="genres" class="form-control">
                <option value="">Select DJ/ Music</option>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well-box feature-left">
              <div class="row">
              <div class="col-md-2 feature-icon"><img src="images/music-dj.svg" alt=""></div>
              <div class="col-md-10 feature-info"><h1>Wedding Music / DJ</h1>

              <p> Find the perfect wedding DJ for your wedding. Search wedding reception DJ reviews and vendors in your area.</p></div>
              </div>
            </div>
            </div>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            ...
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Music / DJ Vendor  Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-2.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Music / DJ Vendor  Title</a></h2>
          ...
          <div class="col-md-4 vendor-box"><!-- venue box start-->
            <div class="vendor-image"><!-- venue pic --> 
              <a href="#"><img src="images/vendor-1.jpg" alt="wedding venue" class="img-responsive"></a> <div class="favourite-bg"><a href="#" class=""><i class="fa fa-heart"></i></a></div></div>
            <!-- /.venue pic -->
            <div class="vendor-detail"><!-- venue details -->
              <div class="caption"><!-- caption -->
                <h2><a href="#" class="title">Music / DJ Vendor  Title</a></h2>
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/music-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:15 GMT -->
</html>