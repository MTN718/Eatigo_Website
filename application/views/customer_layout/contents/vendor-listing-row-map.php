  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">Vendor List + Map View</li>
        </ol>
      </div>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-7 listing-wrap"><!-- listing wrap -->
      <div class="row"> <a class="btn tp-btn-link pull-right" role="button" data-toggle="collapse" href="#searchform" aria-expanded="false" aria-controls="searchform">+ Filter</a></div>
       <div class="row">
...
<!-- Mirrored from jituchauhan.com/wedding/wedding/vendor-listing-row-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 May 2016 10:28:15 GMT -->
</html>