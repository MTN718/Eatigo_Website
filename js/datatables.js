...
$(document).ready(function() {
    ...
    nCloneTd.innerHTML = '<i class="fa fa-plus-circle more_info"></i>';
	...
	$('#example4_wrapper .dataTables_filter input').addClass("input-medium ");
    $('#example4_wrapper .dataTables_length select').addClass("select2-wrapper span12"); 
